...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        LOGGER.info(f"{s}{'' if len(det) else '(no detections), '}{dt[1].dt * 1E3:.3f}ms")
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs_label/train/exp/weights/best.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default='0', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default='data/copy_voc21.yaml', help='(optional) dataset.yaml path')
