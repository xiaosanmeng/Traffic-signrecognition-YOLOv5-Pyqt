...
def evaluate(model, val_data_dir='./data/images'):
    box_size = 368
...
# loading model
# state_dict = torch.load('yolov5s.pt')['state_dict']

state_dict = torch.load('weight/yolov5s.pt')

# create a model instance
model_fp32 = get_pose_model()
model_fp32.load_state_dict(state_dict,False)
model_fp32.float()
...
# save model
torch.save(model_int8.state_dict(),"weight/openpose_vgg_quant.pt")
