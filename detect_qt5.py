...
label_list = ['prohibitory','mandatory','warning']
...
class v5detect:
    ...
    def myloadModelInitialize(self):
        half = False
        weights = ROOT / 'weights/yolov5s-ghost-SE-BIFPN.pt'
        imgsz = [640, 640]
        # Initialize
        set_logging()
    ...
    def run(self,im0s, model, stride, pt, dt, seen, names, device,
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Stream results
            im0 = annotator.result() # 用于绘制预测框和标签
            # if view_img:
        ...
        return label_list[ccls], dt[1], myRes, im0
