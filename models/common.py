...
class MobileNet_Block1(nn.Module):
    def __init__(self, inp, oup, hidden_dim, kernel_size, stride, use_se, use_hs):
        super(MobileNet_Block1, self).__init__()
        assert stride in [1, 2]
...
class DepthSepConv1(nn.Module):
    def __init__(self, inp, oup, kernel_size, stride, use_se):
        super(DepthSepConv1, self).__init__()
...
class ASFFV5(nn.Module):
    ...
    def forward(self, x):  # l,m,s
        ...
        if self.level == 0:
            ...
            level_2_downsampled_inter =nn.functional.max_pool2d(
                x_level_2, 3, stride=2, padding=1)
            level_2_resized = self.stride_level_2(level_2_downsampled_inter)
        elif self.level == 1:
            level_0_compressed = self.compress_level_0(x_level_0)
            level_0_resized = nn.functional.interpolate(
            ...
            level_1_resized = nn.functional.interpolate(
