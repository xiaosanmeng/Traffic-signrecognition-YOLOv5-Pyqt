...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # 根据需要添加模块
        if m in {
                CABlock, h_sigmoid, h_swish, eca_layer, SELayer, conv_bn_hswish, MobileNet_Block, MobileNet_Block1, MobileNet_Block2, DepthSepConv, DepthSepConv1, DepthSepConv2, conv_bn_relu_maxpool, Shuffle_Block,ECA, CBAMC3, CoordAtt, SE, Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
